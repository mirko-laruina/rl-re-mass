...
from multiagent_particle_env import RLlibMultiAgentParticleEnv
...
def main(args):
    ...
    def env_creater(drones_args):
        return Simulator(**drones_args)

    register_env("drones", env_creater)
    ...
    policies = {"policy_%d" %i: gen_policy(i) for i in range(4)}
